    ...
    client.socket.on('playerFires', (data, callback) => {
        if (client.player) {
            ...
            if (client.player.ship.energy >= energyCost) {
                ...
                bullet.x = client.player.ship.x + 30 * Math.cos((client.player.ship.angle + 45) * Math.PI / 180)
                bullet.y = client.player.ship.y + 30 * Math.sin((client.player.ship.angle + 45) * Math.PI / 180)
                ...
                bullet2.x = client.player.ship.x + 30 * Math.cos((client.player.ship.angle - 45) * Math.PI / 180)
                bullet2.y = client.player.ship.y + 30 * Math.sin((client.player.ship.angle - 45) * Math.PI / 180)
